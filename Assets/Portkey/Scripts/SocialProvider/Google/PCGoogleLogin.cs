...
namespace Portkey.SocialProvider
{
    ...
    public class PCGoogleLogin : GoogleLoginBase<GetAccessTokenParam>
    {
        ...
        {
            var requestData  = new FieldFormRequestData<GetAccessTokenParam>
            {
                Url = TOKEN_ENDPOINT,
                FieldFormsObject = new GetAccessTokenParam
                {
                    code = code,
